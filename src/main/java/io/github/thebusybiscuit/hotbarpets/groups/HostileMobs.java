...
public final class HostileMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new SpiderPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SPIDER", PetTexture.SPIDER_PET.getHash(), "&8蜘蛛 &f宠物", getName(), "&7喜欢的食物: 腐肉", "", "&f右键: &7获得跳跃提升"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[]{
        ...
        new GhastPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_GHAST", PetTexture.GHAST_PET.getHash(), "&f恶魂 &f宠物", getName(), "&7喜欢的食物: 火球", "", "&f右键: &7发射火球"), new ItemStack(Material.FIRE_CHARGE), new ItemStack[]{
        ...
        new PhantomPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PHANTOM", PetTexture.PHANTOM_PET.getHash(), "&7幻翼 &f宠物", getName(), "&7喜欢的食物: 甜菜根", "", "&f右键: &7获得缓降"), new ItemStack(Material.BEETROOT), new ItemStack[]{
        ...
        new EndermanPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_MAN", PetTexture.ENDERMAN_PET.getHash(), "&8末影人 &f宠物", getName(), "&7喜欢的食物: 末地石", "", "&f右键: &7发射末影珍珠"), new ItemStack(Material.END_STONE), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_MAGMA_CUBE", PetTexture.MAGMA_CUBE_PET.getHash(), "&4岩浆怪 &f宠物", getName(), "&7喜欢的食物: 下界石英", "", "&f免疫岩浆", "&f快速饥饿"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_BLAZE", PetTexture.BLAZE_PET.getHash(), "&6烈焰人 &f宠物", getName(), "&7喜欢的食物: 下界石英", "", "&f免疫火焰"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ZOMBIE", Material.ZOMBIE_HEAD, "&2僵尸 &f宠物", getName(), "", "&f你可以吃腐肉", "&f不会中毒饥饿"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[] {
