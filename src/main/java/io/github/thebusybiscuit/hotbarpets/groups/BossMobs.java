...
public final class BossMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new EnderDragonPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_DRAGON", Material.DRAGON_HEAD, "&5末影龙 &f宠物", getName(), "&7喜欢的食物: 末影之眼", "", "&f右键: &7发射末影龙火球 & 获得抗性提升"), new ItemStack(Material.ENDER_EYE), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_WITHER", PetTexture.WITHER_PET.getHash(), "&8凋零 &f宠物", getName(), "&7喜欢的食物: 灵魂沙", "", "&f免疫凋零"), new ItemStack(Material.SOUL_SAND), new ItemStack[]{
